...
const testimonials = [
    {
        id: 1,
        quote: "A AR Studios criou um site incrível para minha empresa. O resultado superou todas as expectativas!",
    ...
    {
        id: 2,
        quote: "O agente de IA que desenvolveram automatizou metade do meu trabalho. Simplesmente genial.",
        author: "Pedro Mendes",
    ...
    {
        id: 3,
        quote: "Nosso aplicativo mobile ficou impecável. A atenção aos detalhes é incomparável.",
        author: "Ana Costa",
        role: "Fundadora da DigitalUp",
