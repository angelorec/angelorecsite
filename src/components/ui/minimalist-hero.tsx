    ...
    return (
        ...
        >
            ...
            <div className="relative grid w-full max-w-7xl flex-grow grid-cols-1 items-center gap-8 md:grid-cols-3 md:gap-0 mt-20 md:mt-0">
                ...
                <div className="relative order-1 md:order-2 flex justify-center items-center h-[300px] md:h-full">
                    <div
                        className="absolute z-0 h-[200px] w-[200px] rounded-full md:h-[400px] md:w-[400px] lg:h-[500px] lg:w-[500px]"
                    ...
                    <img
                        ...
                        alt={imageAlt}
                        className="relative z-10 h-auto w-40 object-cover md:w-64 scale-150 lg:w-72 drop-shadow-[0_20px_20px_rgba(0,0,0,0.8)]"
                        onError={(e) => {
                ...
                <motion.div
                    ...
                    className="z-20 order-3 flex items-center justify-center text-center md:text-left md:justify-end"
                >
                    <h1 className="text-5xl font-extrabold text-foreground md:text-8xl lg:text-9xl tracking-tighter leading-[0.9]">
                        {overlayText.part1}
                        <br />
                        {overlayText.part2}
                    </h1>
